...
func (m *ProvenRandomness) GetRoundTime() uint64 {
	if m != nil {
		return m.RoundTime
	}
	return 0
...
var fileDescriptor_61df09207b669f89 = []byte{
	...
	0x24, 0x94, 0x36, 0x31, 0x72, 0x09, 0x04, 0x80, 0x95, 0x07, 0xc1, 0x05, 0x85, 0x44, 0xb8, 0x58,
	...
	0xa6, 0x04, 0xc8, 0x2c, 0xb0, 0xa5, 0x21, 0x99, 0xb9, 0xa9, 0x12, 0x6c, 0x60, 0x57, 0x20, 0x04,
	...
	0x24, 0xa3, 0x34, 0x49, 0x2f, 0x39, 0x3f, 0x57, 0x3f, 0xa5, 0x28, 0x35, 0x31, 0x2f, 0xb3, 0xa4,
	0x52, 0x1f, 0xe2, 0x6b, 0xfd, 0x0a, 0x7d, 0xa4, 0x20, 0x2a, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62,
	0x03, 0x87, 0x8b, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x37, 0x60, 0x12, 0x7f, 0x3d, 0x01, 0x00,
	0x00,
}
...
func (m *ProvenRandomness) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RoundTime != 0 {
		i = encodeVarintProvenRandomness(dAtA, i, uint64(m.RoundTime))
		i--
		dAtA[i] = 0x30
	}
...
func (m *ProvenRandomness) Size() (n int) {
	...
	if m.RoundTime != 0 {
		n += 1 + sovProvenRandomness(uint64(m.RoundTime))
	}
	return n
}

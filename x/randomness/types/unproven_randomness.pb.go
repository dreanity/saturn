...
func (m *UnprovenRandomness) GetRoundTime() uint64 {
	if m != nil {
		return m.RoundTime
	}
	return 0
...
var fileDescriptor_93683a8388412f68 = []byte{
	...
	0xe9, 0x21, 0x24, 0x94, 0x3c, 0xb8, 0x84, 0x42, 0xa1, 0xea, 0x83, 0xe0, 0xa2, 0x42, 0x22, 0x5c,
	0xac, 0x45, 0xf9, 0xa5, 0x79, 0x29, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x2c, 0x41, 0x10, 0x8e, 0x90,
	0x0c, 0x17, 0x27, 0x98, 0x11, 0x92, 0x99, 0x9b, 0x2a, 0xc1, 0x04, 0x96, 0x41, 0x08, 0x38, 0xb9,
	...
	0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x7e, 0x4a, 0x51, 0x6a, 0x62, 0x5e, 0x66, 0x49, 0xa5, 0x3e,
	0xc4, 0x29, 0xfa, 0x15, 0xfa, 0x48, 0x2e, 0x2f, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x3b,
	0xd6, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xdf, 0x51, 0x71, 0xfc, 0xd4, 0x00, 0x00, 0x00,
}
...
func (m *UnprovenRandomness) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RoundTime != 0 {
		i = encodeVarintUnprovenRandomness(dAtA, i, uint64(m.RoundTime))
		i--
		dAtA[i] = 0x10
	}
	if m.Round != 0 {
...
func (m *UnprovenRandomness) Size() (n int) {
	...
	if m.RoundTime != 0 {
		n += 1 + sovUnprovenRandomness(uint64(m.RoundTime))
	}
	return n
}

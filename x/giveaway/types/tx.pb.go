...
type MsgCreateGiveaway struct {
	...
	RoundCount uint64 `protobuf:"varint,3,opt,name=roundCount,proto3" json:"roundCount,omitempty"`
...
func (m *MsgCreateGiveaway) GetRoundCount() uint64 {
	if m != nil {
		return m.RoundCount
	}
	return 0
...
var fileDescriptor_97ad54ab600213fb = []byte{
	...
	,
}
...
func (m *MsgCreateGiveaway) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RoundCount != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.RoundCount))
		i--
		dAtA[i] = 0x18
	}
	if m.Duration != 0 {
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RoundCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

...
func (m *Giveaway) GetRoundCount() uint64 {
	if m != nil {
		return m.RoundCount
	}
	return 0
...
var fileDescriptor_1cf0a435194c6a42 = []byte{
	...
	,
	...
	0xea, 0xc3, 0x8c, 0xd4, 0x87, 0x18, 0xa9, 0x5f, 0x01, 0x0f, 0x3e, 0xfd, 0x92, 0xca, 0x82, 0xd4,
	0xe2, 0x24, 0x36, 0xb0, 0xff, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x91, 0x61, 0xf2, 0xd7,
	0x60, 0x01, 0x00, 0x00,
}
...
func (m *Giveaway) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RoundCount != 0 {
		i = encodeVarintGiveaway(dAtA, i, uint64(m.RoundCount))
		i--
		dAtA[i] = 0x18
	}
	if m.Duration != 0 {
...
func (m *Giveaway) Size() (n int) {
	...
	if m.RoundCount != 0 {
		n += 1 + sovGiveaway(uint64(m.RoundCount))
	}
	l = len(m.Name)
	if l > 0 {

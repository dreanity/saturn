...
import (
	...
	gentimemodule "github.com/dreanity/saturn/x/gentime"
	gentimemodulekeeper "github.com/dreanity/saturn/x/gentime/keeper"
	gentimemoduletypes "github.com/dreanity/saturn/x/gentime/types"
	...
	treasurymodule "github.com/dreanity/saturn/x/treasury"
	treasurymodulekeeper "github.com/dreanity/saturn/x/treasury/keeper"
	treasurymoduletypes "github.com/dreanity/saturn/x/treasury/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "saturn"
	Name                 = "saturn"
)
...
var (
	...
	maccPerms = map[string][]string{
		...
		randomnessmoduletypes.ModuleName: {authtypes.Minter},
...
func New(
	...
	app.RandomnessKeeper = *randomnessmodulekeeper.NewKeeper(
		appCodec,
		keys[randomnessmoduletypes.StoreKey],
		keys[randomnessmoduletypes.MemStoreKey],
		app.GetSubspace(randomnessmoduletypes.ModuleName),
		app.BankKeeper,
	)
	...
	app.GentimeKeeper = *gentimemodulekeeper.NewKeeper(
		...
		keys[gentimemoduletypes.MemStoreKey],

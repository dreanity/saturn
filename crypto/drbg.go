// drbg.go implements the HMAC_DRBG construct as per NIST Special
...
func NewHmacDrbg(hash crypto.Hash, entropyInput, nonce, personalizationString []byte) (*Drbg, error) {
	outLen := hash.Size()
	minLen := outLen / 2
